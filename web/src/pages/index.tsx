    ...
    <div className="max-w-[1124px] h-screen mx-auto grid gap-28 grid-cols-2 items-center">
      ...
      <Image src={LogoImg} alt='NLW Copa'/>
        ...
        <div className="mt-10 flex items-center gap-2">
          <Image 
          src={usersAvatarExampleImg} alt=""
          quality={100}
          />
          
          <strong className="text-gray-100 text-xl">
            <span className="text-green-300">+  {props.userCount}</span> pessoas já estão usando
          </strong>
        </div>
      ...
      <Image 
      src={appPreviewImage}
      alt='Dois celulares exibindo a aplicação móvel do NLW Copa'
      quality={100}
      />
